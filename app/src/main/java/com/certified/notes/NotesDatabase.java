...
public abstract class NotesDatabase extends RoomDatabase {
    ...
    private static final RoomDatabase.Callback roomCallback = new RoomDatabase.Callback() {
        ...
        public void onCreate(@NonNull SupportSQLiteDatabase db) {
            ...
            Note note1 = new Note("MTS 301", "Dynamic intent resolution", "Wow, intents allow components to be resolved at runtime");
            Note note2 = new Note("CPE 301", "Parameters", "Leverage variable-length parameter lists?");
            Note note3 = new Note("MTS 301", "Delegating intents", "PendingIntents are powerful; they delegate much more than just a component invocation");
            Note note4 = new Note("AGE 301", "Compiler options", "The -jar option isn't compatible with with the -cp option");
            Note note5 = new Note("AGE 301", "Serialization", "Remember to include SerialVersionUID to assure version compatibility");
            Note note6 = new Note("GNS 201", "Service default threads", "Did you know that by default an Android Service will tie up the UI thread?");
            Note note7 = new Note("CPE 301", "Anonymous classes", "Anonymous classes simplify implementing one-use types");
            Note note8 = new Note("GNS 201", "Long running operations", "Foreground Services can be tied to a notification icon");
            ...
            Todo todo1 = new Todo("Wash the fucking toilet bro", false);
