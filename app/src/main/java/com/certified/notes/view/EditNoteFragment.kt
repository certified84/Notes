...
import com.certified.notes.view.BookMarks.BookMarksViewModel
import com.certified.notes.view.BookMarks.BookMarksViewModelFactory
            ...
            when (which) {
                "note" -> {
                    ...
                    btnUpdate.setOnClickListener {
                        ...
                        if (noteTitle.isNotBlank() && noteContent.isNotBlank() && courseCode != "Not set") {
                            ...
                            if (spinnerCourses.selectedItemPosition != 0) {
